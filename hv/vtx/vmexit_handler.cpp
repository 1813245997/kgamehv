...
void vmexit_mov_dr_handler(__vcpu* vcpu) 
{
	...
	// (See Section 17.2, 揇ebug Registers? of the Intel?64 and IA-32 Architectures Software Developer抯 Manual, Volume 3A, 
...
void vmexit_rdrand_handler(__vcpu* vcpu)
{
	...
	// (see Intel?64 and IA-32 Architectures Software Developer抯 Manual, Volume 1, Section 7.3.17, 揜andom Number Generator Instructions?.
...
{
	//
	// Invalidates (flushes) the processor抯 internal caches and issues a special-function bus cycle that directs 
...
void vmexit_cr_handler(__vcpu* vcpu)
{
	...
	//// The operand size for these instructions is always 32 bits in non-64-bit modes, regardless of the operand-size attribute.
	//// (See 揅ontrol Registers?in Chapter 2 of the Intel?64 and IA-32 Architectures Software Developer抯 Manual,
	...
	//// See the description of the TS flag in the section titled 揅ontrol Registers?
	//// in Chapter 2 of the Intel?64 and IA - 32 Architectures Software Developer抯 Manual, Volume 3A, for more information about this flag.
	////
	//case CR_ACCESS_CLTS:
	//{
