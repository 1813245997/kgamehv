...
namespace hv
{
    uint64_t gva2gpa(cr3 guest_cr3, void* gva, size_t* offset_to_next_page)
    {
    ...
    uint64_t gva2gpa(void* gva, size_t* offset_to_next_page)
    {
        cr3 guest_cr3;
        guest_cr3.flags =  hv:: vmread(VMCS_GUEST_CR3);
        return gva2gpa(guest_cr3, gva, offset_to_next_page);

    }

    void* gva2hva(cr3 guest_cr3, void* gva, size_t* offset_to_next_page)
    {
    ...
    void* gva2hva(void* gva, size_t* offset_to_next_page)
    {
        cr3 guest_cr3;
        guest_cr3.flags = hv:: vmread(VMCS_GUEST_CR3);
