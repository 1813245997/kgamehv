...
{
    return (T)  utils::memory::allocate_independent_pages(size, PAGE_EXECUTE_READWRITE);
}
...
{ 
    return (T*)utils::memory::allocate_independent_pages(sizeof(T), PAGE_EXECUTE_READWRITE);
}
